...
*   checking dependencies in R code ... NOTE
    ```
    [c4-n43:2866805] OPAL ERROR: Not initialized in file ext2x_client.c at line 112
    --------------------------------------------------------------------------
...
* Date/Publication: 2025-03-16 06:00:02 UTC
...
*   checking tests ...
    ```
      ...
      Running ‘foreach_dofuture,nested_colon.R’
     ERROR
    Running the tests in ‘tests/foreach_dofuture,nested_colon.R’ failed.
    Last 50 lines of output:
      [20:48:25.405]   - Argument 'globals':
      
      [20:48:25.405]  logi TRUE
    ...
      [20:48:25.417] - identifying globals and packages ... DONE
      [20:48:25.417] Launching 1 futures (chunks) ...
      [20:48:25.418] Chunk #1 of 1 ...
      [20:48:25.418]  - Finding globals in 'args_list' for chunk #1 ...
      [20:48:25.418] 
      [20:48:25.418] 
      [20:48:25.418]  - Finding globals in 'args_list' for chunk #1 ... DONE
      [20:48:25.418]  - seeds: <none>
      Error: future::evalFuture() failed on c4-n43 (pid 3191834) at 2025-03-26T20:48:25. Possible other reasons: there is no connection 5
      Execution halted
    ```
...
*   checking Rd cross-references ... NOTE
    ```
    Unknown package ‘doParallel’ in Rd xrefs
    ```
...
*   checking dependencies in R code ... NOTE
    ```
    [c4-n43:3742892] OPAL ERROR: Not initialized in file ext2x_client.c at line 112
    --------------------------------------------------------------------------
    The application appears to have been direct launched using "srun",
    but OMPI was not built with SLURM's PMI support and therefore cannot
    execute. There are several options for building PMI support under
...
*   checking tests ...
    ```
      Running ‘testthat.R’/software/c4/cbi/software/_rocky8/R-4.4.3-gcc13/lib64/R/bin/BATCH: line 60: 3838466 Aborted                 (core dumped) ${R_HOME}/bin/R -f ${in} ${opts} ${R_BATCH_OPTIONS} > ${out} 2>&1
...
*   checking tests ...
    ```
      Running ‘testthat.R’/software/c4/cbi/software/_rocky8/R-4.4.3-gcc13/lib64/R/bin/BATCH: line 60: 551408 Aborted                 (core dumped) ${R_HOME}/bin/R -f ${in} ${opts} ${R_BATCH_OPTIONS} > ${out} 2>&1
...
*   checking re-building of vignette outputs ... ERROR
    ...
    Quitting from Introduction_2_query_variants.Rmd:61-68 [unnamed-chunk-2]
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    <error/rlang_error>
    ...
...
* Date/Publication: 2025-03-20 13:40:02 UTC
...
*   checking tests ...
    ...
    ...
       2. └─sims::sims_simulate("a ~ dunif(0,1)", nsims = 1L)
       3.   └─sims:::generate_datasets(...)
       4.     └─future.apply::future_lapply(...)
       5.       └─future.apply:::future_xapply(...)
       6.         ├─future::value(fs)
       7.         └─future:::value.list(fs)
      
      [ FAIL 33 | WARN 0 | SKIP 1 | PASS 73 ]
      Error: Test failures
      Execution halted
    ```
