...
Future 'b2' ...
 b.pid b1.pid b2.pid 
760226 760634 760635 
```

which clearly show that `a` and `b` are resolved in the calling
process (pid 760226) whereas the two nested futures (`b1` and
`b2`) are resolved in two separate R processes (pids 760634 and
760635).
