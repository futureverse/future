...
Future 'b2' ...
  b.pid  b1.pid  b2.pid 
2579372 2579780 2579779 
```

which clearly show that `a` and `b` are resolved in the calling
process (pid 2579372) whereas the two nested futures (`b1` and
`b2`) are resolved in two separate R processes (pids 2579780 and
2579779).
