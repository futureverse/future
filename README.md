...
Future 'b2' ...
  b.pid  b1.pid  b2.pid 
1389228 1389685 1389686 
```

which clearly show that `a` and `b` are resolved in the calling
process (pid 1389228) whereas the two nested futures (`b1` and
`b2`) are resolved in two separate R processes (pids 1389685 and
1389686).
