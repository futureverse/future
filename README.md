...
Future 'b2' ...
  b.pid  b1.pid  b2.pid 
1920900 1921309 1921308 
```

which clearly show that `a` and `b` are resolved in the calling
process (pid 1920900) whereas the two nested futures (`b1` and
`b2`) are resolved in two separate R processes (pids 1921309 and
1921308).
