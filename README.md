...
Future 'b2' ...
 b.pid b1.pid b2.pid 
769171 769583 769582 
```

which clearly show that `a` and `b` are resolved in the calling
process (pid 769171) whereas the two nested futures (`b1` and
`b2`) are resolved in two separate R processes (pids 769583 and
769582).
