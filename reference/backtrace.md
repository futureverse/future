...
#>     NULL
#>     base::saveRDS(base::do.call(base::do.call, base::c(base::readRDS("/tmp/hb/Rtmpvn8AVP/callr-fun-1171ef2d324a59"), 
#>         base::list(envir = .GlobalEnv, quote = TRUE)), envir = .GlobalEnv, 
#>         quote = TRUE), file = "/tmp/hb/Rtmpvn8AVP/callr-res-1171ef52bf4768", 
#>         compress = FALSE)
...
#>         }
#>         base::saveRDS(base::list("error", e2, e), file = base::paste0("/tmp/hb/Rtmpvn8AVP/callr-res-1171ef52bf4768", 
#>             ".error"))
#>     }
...
#> 
#> [[10]]
#> base::do.call(base::do.call, base::c(base::readRDS("/tmp/hb/Rtmpvn8AVP/callr-fun-1171ef2d324a59"), 
#>     base::list(envir = .GlobalEnv, quote = TRUE)), envir = .GlobalEnv, 
#>     quote = TRUE)
#> 
#> [[11]]
...
#>     src_path = "/tmp/hb/Rtmpvn8AVP/future", meta = list(url = "https://future.futureverse.org", 
...
#>         prefix = ""), prefix = "", dst_path = "/tmp/hb/Rtmpvn8AVP/future/docs", 
