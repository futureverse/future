...
#>     NULL
#>     base::saveRDS(base::do.call(base::do.call, base::c(base::readRDS("/tmp/hb/Rtmp7roD2v/callr-fun-c96f4f2fd6b1"), 
#>         base::list(envir = .GlobalEnv, quote = TRUE)), envir = .GlobalEnv, 
#>         quote = TRUE), file = "/tmp/hb/Rtmp7roD2v/callr-res-c96f4475ca4a", 
#>         compress = FALSE)
...
#>         }
#>         base::saveRDS(base::list("error", e2, e), file = base::paste0("/tmp/hb/Rtmp7roD2v/callr-res-c96f4475ca4a", 
#>             ".error"))
#>     }
...
#> 
#> [[10]]
#> base::do.call(base::do.call, base::c(base::readRDS("/tmp/hb/Rtmp7roD2v/callr-fun-c96f4f2fd6b1"), 
#>     base::list(envir = .GlobalEnv, quote = TRUE)), envir = .GlobalEnv, 
#>     quote = TRUE)
#> 
#> [[11]]
...
#>     src_path = "/tmp/hb/Rtmp7roD2v/future", meta = list(url = "https://future.futureverse.org", 
...
#>         prefix = ""), prefix = "", dst_path = "/tmp/hb/Rtmp7roD2v/future/docs", 
