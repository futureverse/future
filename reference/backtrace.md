...
#>     NULL
#>     base::saveRDS(base::do.call(base::do.call, base::c(base::readRDS("/tmp/hb/RtmpQ7uO2L/callr-fun-16e9d2313480b8"), 
#>         base::list(envir = .GlobalEnv, quote = TRUE)), envir = .GlobalEnv, 
#>         quote = TRUE), file = "/tmp/hb/RtmpQ7uO2L/callr-res-16e9d2364d9230", 
#>         compress = FALSE)
...
#>         }
#>         base::saveRDS(base::list("error", e2, e), file = base::paste0("/tmp/hb/RtmpQ7uO2L/callr-res-16e9d2364d9230", 
#>             ".error"))
#>     }
...
#> 
#> [[10]]
#> base::do.call(base::do.call, base::c(base::readRDS("/tmp/hb/RtmpQ7uO2L/callr-fun-16e9d2313480b8"), 
#>     base::list(envir = .GlobalEnv, quote = TRUE)), envir = .GlobalEnv, 
#>     quote = TRUE)
#> 
#> [[11]]
...
#>     pkgdown::build_site(...)
#> }), base::quote(list(pkg = list(package = "future", version = "1.70.0-9024", 
#>     src_path = "/tmp/hb/RtmpQ7uO2L/future", meta = list(url = "https://future.futureverse.org", 
...
#>         navbar = list(structure = list(left = c("intro", "reference", 
#>         "articles", "news"), right = c("search", "futureverse", 
...
#>                 list(text = "futurize (map-reduce)", href = "https://futurize.futureverse.org"), 
...
#>                 list(text = "progressify", href = "https://progressify.futureverse.org"), 
...
#>         prefix = ""), prefix = "", dst_path = "/tmp/hb/RtmpQ7uO2L/future/docs", 
...
#>                   " will capture\n", "all ", list("condition"), 
#>                   " classes except those that inherit from the ", 
#>                   list("message"), " class.\n", "Using ", list(
...
#>                     list("stats"), "\n", "package, is not exported.  Instead, it ensures that the ", 
...
#>                     "x"), " is first queried, the value of the future\n", 
#>                   "is automatically retrieved as if it were a regular variable and ", 
...
#>                     "to be attached for the evaluation to succeed, use ", 
#>                     list("%packages%"), ". For\n", "example,\n", 
...
#>                     "an informative error is thrown, otherwise ", 
#>                     list("default"), " is returned.")), "\n", 
...
#>                         ", this resolves futures in parallel in\n", 
...
#>                         ":"), list("\n", "Similar to ", list(
#>                         "multisession"), ", this resolves futures in parallel in\n", 
#>                         "background ", list(), " sessions on the local machine via the ", 
#>                         list("mirai"), "\n", "package, e.g. ", 
#>                         list("plan(future.mirai::mirai_multisession)"), 
...
#>                         ":"), list("\n", "Similar to ", list(
#>                         "cluster"), ", this resolves futures in parallel via\n", 
...
#>         cli.hyperlink_run = hyperlinks)
#>     pkgdown::build_site(...)
#> })(pkg = base::quote(list(package = "future", version = "1.70.0-9024", 
#>     src_path = "/tmp/hb/RtmpQ7uO2L/future", meta = list(url = "https://future.futureverse.org", 
#>         home = list(links = list(list(text = "Roadmap/Milestones", 
#>             href = "https://github.com/futureverse/future/milestones"), 
#>             list(text = "The Futureverse Project", href = "https://www.futureverse.org/"), 
