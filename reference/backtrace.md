...
#>     NULL
#>     base::saveRDS(base::do.call(base::do.call, base::c(base::readRDS("/tmp/hb/RtmpqJ7hLe/callr-fun-ee46d3e807e50"), 
#>         base::list(envir = .GlobalEnv, quote = TRUE)), envir = .GlobalEnv, 
#>         quote = TRUE), file = "/tmp/hb/RtmpqJ7hLe/callr-res-ee46d529faa84", 
#>         compress = FALSE)
...
#>         }
#>         base::saveRDS(base::list("error", e2, e), file = base::paste0("/tmp/hb/RtmpqJ7hLe/callr-res-ee46d529faa84", 
#>             ".error"))
#>     }
...
#> 
#> [[10]]
#> base::do.call(base::do.call, base::c(base::readRDS("/tmp/hb/RtmpqJ7hLe/callr-fun-ee46d3e807e50"), 
#>     base::list(envir = .GlobalEnv, quote = TRUE)), envir = .GlobalEnv, 
#>     quote = TRUE)
#> 
#> [[11]]
...
#>     pkgdown::build_site(...)
#> }), base::quote(list(pkg = list(package = "future", version = "1.70.0-9019", 
#>     src_path = "/tmp/hb/RtmpqJ7hLe/future", meta = list(url = "https://future.futureverse.org", 
...
#>         prefix = ""), prefix = "", dst_path = "/tmp/hb/RtmpqJ7hLe/future/docs", 
...
#>         cli.hyperlink_run = hyperlinks)
#>     pkgdown::build_site(...)
#> })(pkg = base::quote(list(package = "future", version = "1.70.0-9019", 
#>     src_path = "/tmp/hb/RtmpqJ7hLe/future", meta = list(url = "https://future.futureverse.org", 
#>         home = list(links = list(list(text = "Roadmap/Milestones", 
#>             href = "https://github.com/futureverse/future/milestones"), 
#>             list(text = "The Futureverse Project", href = "https://www.futureverse.org/"), 
