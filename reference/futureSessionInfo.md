...
futureSessionInfo()
#> *** Package versions
#> future 1.68.0.9031, parallelly 1.45.1.9011, parallel 4.5.2, globals 0.18.0, listenv 0.10.0
#> 
#> *** Allocations
#> availableCores():
...
#> 1 1710093 4.5.2   Linux 6.14.0-36-generic
#>                                                            version nodename
#> 1 #36~24.04.1-Ubuntu SMP PREEMPT_DYNAMIC Wed Oct 15 15:45:17 UTC 2  host001
#>   machine   login    user effective_user
#> 1  x86_64 user001 user001        user001
#> Worker R session details:
#>   worker     pid     r sysname           release
#> 1      1 1710920 4.5.2   Linux 6.14.0-36-generic
#> 2      2 1710921 4.5.2   Linux 6.14.0-36-generic
#>                                                            version nodename
#> 1 #36~24.04.1-Ubuntu SMP PREEMPT_DYNAMIC Wed Oct 15 15:45:17 UTC 2  host001
#> 2 #36~24.04.1-Ubuntu SMP PREEMPT_DYNAMIC Wed Oct 15 15:45:17 UTC 2  host001
#>   machine   login    user effective_user
#> 1  x86_64 user001 user001        user001
