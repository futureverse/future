...
futureSessionInfo()
#> *** Package versions
#> future 1.69.0.9003, parallelly 1.46.1.9005, parallel 4.5.2, globals 0.19.0, listenv 0.10.0.9002
#> 
#> *** Allocations
#> availableCores():
...
#> 1 1089196 4.5.2   Linux 6.14.0-37-generic
#>                                                            version nodename
...
#> 1      1 1090213 4.5.2   Linux 6.14.0-37-generic
#> 2      2 1090214 4.5.2   Linux 6.14.0-37-generic
#>                                                            version nodename
#> 1 #37~24.04.1-Ubuntu SMP PREEMPT_DYNAMIC Thu Nov 20 10:25:38 UTC 2  host001
